    ...
    public static WebDriver buildDriver(String browserName, String path) throws MalformedURLException {
        switch (browserName) {
            case "chrome_invisible":
                ...
                preferences2.put("download.default_directory", path);
                preferences2.put("plugins.always_open_pdf_externally", true);
                chromeInvisibleOpt.setExperimentalOption("prefs", preferences2);
